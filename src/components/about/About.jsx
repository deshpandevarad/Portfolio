...
const About = () => {
  const downloadPdf = () => {
    ...
    link.href = "/image/Varad Deshpande.pdf";
    link.download = 'Varad Deshpande.pdf';
        ...
        <div className="about__data grid">
          <div className="about__info">
            <p className="about__description">
              I am Varad Vivek Deshpande, Pursuing B.Tech in Computer Science & Engineering with 7.16 CGPA. Passionate Front-End Developer proficient in HTML, CSS, and JavaScript  with a understanding of frameworks like ReactJs and Bootstrap.
            </p>
