...
const data = [
  {
    ...
    description: "Expertise in web development with HTML, CSS, JavaScript, ReactJS, and Bootstrap for frontend. Experienced with Git/GitHub and Power BI. Capable of developing dynamic web applications with a focus on user experience."
  },
  {
    id: 3,
